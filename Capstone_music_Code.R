...
###################################################
#loading the data
Hot_100_Audio_Features <- read.csv("~/Data science/Projects/Capstone_Music/source_data/kcmillersean-billboard-hot-100-1958-2017/Hot 100 Audio Features.csv")
genres_v2 <- read.csv("~/Data science/Projects/Capstone_Music/source_data/archive (1)/genres_v2.csv")
